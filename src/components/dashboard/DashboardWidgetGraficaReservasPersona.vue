<template>
  <div class="rounded-xl bg-app-bg/60 border border-app-border-subtle p-4">
    <p class="text-[11px] font-medium text-brand-accent uppercase tracking-wider mb-3">Reservas por persona</p>
    ...
    <div v-else class="space-y-2">
      ...
      >
        <span class="text-sm text-app-title truncate min-w-0 flex-1" :title="item.label">{{ item.label }}</span>
