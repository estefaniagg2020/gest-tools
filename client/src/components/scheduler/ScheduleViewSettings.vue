<template>
  <div class="app-card p-4">
    <label class="text-sm font-medium text-app-text mb-2 block">
      {{ SCHEDULE_VIEW_SETTINGS.SECTION_TITLE }}
    </label>
    <div class="space-y-3">
      <div>
        <label class="text-xs text-app-text/80 block mb-0.5">{{ SCHEDULE_VIEW_SETTINGS.LABEL_START_HOUR }}</label>
        <select
          :value="startHour"
      ...
      <div>
        <label class="text-xs text-app-text/80 block mb-0.5">{{ SCHEDULE_VIEW_SETTINGS.LABEL_END_HOUR }}</label>
        <select
          :value="endHour"
      ...
      <div>
        <label class="text-xs text-app-text/80 block mb-0.5">{{ SCHEDULE_VIEW_SETTINGS.LABEL_SLOT_DURATION }}</label>
        <select
      ...
      <div>
        <label class="text-xs text-app-text/80 block mb-0.5">{{ SCHEDULE_VIEW_SETTINGS.LABEL_PIXELS_PER_HOUR }}</label>
        <select
          :value="pixelsPerHour"
