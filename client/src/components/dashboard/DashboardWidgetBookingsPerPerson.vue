<template>
  <div class="rounded-xl bg-app-bg/60 border border-app-border-subtle p-5 flex flex-col min-h-64">
    ...
    <div v-else class="flex-1 flex items-end justify-around gap-3 pb-2">
      <div
      ...
      >
        ...
        <div class="w-full rounded-t-xl min-h-[8px] transition-all duration-700"
          :style="{ height: barHeight(item.count), backgroundColor: colors[i % colors.length] + 'cc' }" />
